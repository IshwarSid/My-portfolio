...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    try {
      ...
      // Set dummy/mock functions to degrade gracefully
      this.tick = () => {};
      this.init = () => {};
      this.setSize = () => {};
      this.onMouseDown = () => {};
      ...
      this.onContextMenu = () => {};
      this.onWindowResize = () => {};
      this.loadAssets = () => Promise.resolve();
      this.dispose = () => {};
      
      // Initialize dummy properties to satisfy compiler type checks
